...
ssh -o StrictHostKeyChecking=no -i keypairs/keypair-instance3 sudo rm -r database/
scp -o StrictHostKeyChecking=no -i keypairs/keypair-instance3 -r database/ ubuntu@$INSTANCE3
...
ssh -o StrictHostKeyChecking=no -i keypairs/keypair-instance4 sudo rm -r database/
scp -o StrictHostKeyChecking=no -i keypairs/keypair-instance4 -r database/ ubuntu@$INSTANCE4
